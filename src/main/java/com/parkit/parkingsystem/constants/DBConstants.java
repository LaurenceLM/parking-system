...
public class DBConstants {
    ...
    public static final String GET_OLD_TICKET = "select ID, PRICE, IN_TIME, OUT_TIME from ticket where VEHICLE_REG_NUMBER = ? and OUT_TIME is not null order by OUT_TIME limit 1;";
}
